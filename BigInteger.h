...
public:
    ...
    ~BigInteger();
    BigInteger add(long long int)const;
    ...
    int compareTo(long long int)const;
    ...
    BigInteger mul(long long int b2)const;
    BigInteger operator*(const BigInteger& b2)const;
    ...
    BigInteger div(const BigInteger& num,bool open=false);
    BigInteger div(const long long int num);
    BigInteger div(string num);
    ...
    BigInteger mod(const long long int num);
    BigInteger mod(string num);
